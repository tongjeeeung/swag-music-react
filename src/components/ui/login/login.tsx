  ...
  return (
    <div className={styles.login}>
      ...
      <form className={styles.form} name="login" onSubmit={handleFormSubmit}>
        ...
        />
        {localErrors.email && (
          <p className={styles.error}>{localErrors.email}</p>
        )}
        ...
        {localErrors.password && (
          <p className={styles.error}>{localErrors.password}</p>
        )}

        <Link to={"/swag-music-react/forgot"} className={styles.forgot}>
          Forgot your password?
        </Link>
        <button className={styles.button} type="submit">
          Login
        </button>
        <Link to={"/swag-music-react/registration"} className={styles.button}>
          Registration
        </Link>
      </form>
    </div>
