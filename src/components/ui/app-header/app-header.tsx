...
import logoGif from "../../../../public/static/images/default/logo.png";
...
export const AppHeaderUI: FC<TAppHeaderUIProps> = ({
  ...
  useEffect(() => {
    if (headerRef.current && profileRef.current && contentRef.current) {
      ...
      const contentOutHandle = (e: MouseEvent) => {
        ...
        if (
          target &&
          !target.classList.contains(styles.link) &&
          !target.classList.contains(`${styles.link}:hover`) &&
      ...
      contentRef.current.addEventListener("mouseout", (e) =>
        contentOutHandle(e),
      );
  ...
  return (
    <>
      {isSearch && (
        <SearchUI artists={artists} handleSearch={handleSearch}></SearchUI>
      )}
      <header className={styles.header} ref={headerRef}>
        <ul className={styles.header_menu}>
          <Link
            to={"/swag-music-react/home"}
            style={{ textDecoration: "none", color: "inherit" }}
          >
            <li className={styles.menu_item}>Home</li>
          </Link>
          <Link
            to={"/swag-music-react/playlists"}
            style={{ textDecoration: "none", color: "inherit" }}
          >
            <li className={styles.menu_item}>Playlist</li>
          </Link>
          <li className={styles.menu_item} onClick={handleSearch}>
            Search
          </li>
        </ul>
        ...
        <ul className={styles.header_menu}>
          <Link
            to={"/swag-music-react/blog"}
            style={{ textDecoration: "none", color: "inherit" }}
          >
            <li className={styles.menu_item}>Blog</li>
          </Link>
          <Link
            to={"/swag-music-react/information"}
            style={{ textDecoration: "none", color: "inherit" }}
          >
            <li className={styles.menu_item}>Information</li>
          </Link>
          {userName ? (
            <li className={styles.menu_item} ref={profileRef}>
              <img
        ...
        <div className={styles.content} ref={contentRef}>
          <Link to={"/swag-music-react/profile"} className={styles.link}>
            Profile
          </Link>
          <button className={styles.link} onClick={logOutHandle}>
            Log out
          </button>
        </div>
      </header>
