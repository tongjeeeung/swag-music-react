...
export const SliderUI: FC<{
  sliderVoid(arg: HTMLUListElement): void;
  items: TPlaylist[];
  listenHandle(playlist: TPlaylist): void;
}> = ({ sliderVoid, items, listenHandle }) => {
  ...
  return (
    <section className={styles.slider}>
      ...
      >
        {items.map((playlist: TPlaylist, index: number) => (
          <li className={styles.list_item} key={index}>
            <img
              className={styles.list_bg_img}
              src={playlist.executorImg}
              alt={playlist.executor}
            />
            <div className={styles.list_info}>
              <Link
                to={`/swag-music-react/executor/${playlist.executorID}`}
            ...
            <div className={styles.position}>
              ...
              >
                <img
                  ...
                  src={typeof playlist.image === "string" ? playlist.image : ""}
                  alt={playlist.name}
                />
