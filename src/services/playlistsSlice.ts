...
export const getAllPlaylistsThunk = createAsyncThunk(
  "playlists/fetchAll",
  async () => {
...
export const postNewUserPlaylistThunk = createAsyncThunk(
  "playlists/postNewUserPlaylist",
...
export const ubdateUserPlaylistThunk = createAsyncThunk(
  "playlists/ubdateUserPlaylistThunk",
  async (playlist: TPlaylist) => {
...
export const deleteUserPlaylistThunk = createAsyncThunk(
  "playlists/deleteUserPlaylistThunk",
  async (playlist: TPlaylist) => {
