...
const jesus = {
  name: 'Джизус',
  image: '/static/images/executors/jezus/executor.jpeg',
  ...
  playlists: [{
    name: 'Не пара',
    image: '/public/static/images/executors/jezus/album1.jpg',
    ...
    tracks: [{
      name: 'Не пара',
      duration: '3:26',
      url: '/static/images/executors/jezus/tracks/Не пара.mp3'
    }],
  },
  {
    name: '47 - Revolution and World',
    image: '/static/images/executors/jezus/album2.jpg',
    ...
    tracks: [{
      name: 'Ночь',
      duration: '2:55',
      url: '/static/images/executors/jezus/tracks/Ночь.mp3',
    },
    {
      name: "LOVE",
      url: '/static/images/executors/jezus/tracks/LOVE.mp3',
      duration: '3:58',
    },
    {
      name: "XXXXstyle",
      url: '/static/images/executors/jezus/tracks/XXXXstyle.mp3',
      duration: '3:02',
    },
    {
      name: "Ветер моих перемен",
      url: '/static/tracks/Джизус - Ветер моих перемен.mp3',
      duration: '3:03',
    },
    {
      name: "Во имя любви",
      url: '/static/images/executors/jezus/tracks/Ветер моих перемен.mp3',
      duration: '2:42',
    },
    {
      name: "Войной",
      url: '/static/images/executors/jezus/tracks/Войной.mp3',
      duration: '2:06',
    },
    {
      name: "Выбор за тобой",
      url: '/static/images/executors/jezus/tracks/Выбор за тобой.mp3',
      duration: '3:58',
    },
    {
      name: "Давай со мной",
      url: '/static/images/executors/jezus/tracks/Давай со мной.mp3',
      duration: '3:04',
    },
    {
      name: "Дыхание с тобой",
      url: '/static/images/executors/jezus/tracks/Дыхание с тобой.mp3',
      duration: '3:01',
    },
    {
      name: "Запутанный день",
      url: '/static/images/executors/jezus/tracks/Запутанный день.mp3',
      duration: '3:52',
    },
    {
      name: "Наши сердца",
      url: '/static/images/executors/jezus/tracks/Наши сердца.mp3',
      duration: '3:49',
    },
    {
      name: "Небом и звездой",
      url: '/static/images/executors/jezus/tracks/Небом и звездой.mp3',
      duration: '4:51',
    },
    {
      name: "Поколение моё",
      url: '/static/images/executors/jezus/tracks/Поколение моё.mp3',
      duration: '3:45',
    },
    {
      name: "Пора что-то менять",
      url: '/static/images/executors/jezus/tracks/Пора что-то менять.mp3',
      duration: '2:22',
    },
    {
      name: "Человек, который изменил всё",
      url: '/static/images/executors/jezus/tracks/Человек, который изменил всё.mp3',
      duration: '2:26',
    },
    {
      name: "Я умираю для тебя",
      url: '/static/images/executors/jezus/tracks/Я умираю для тебя.mp3',
      duration: '2:59',
    },
    {
      name: "Я ухожу",
      url: '/static/images/executors/jezus/tracks/Я ухожу.mp3',
      duration: '4:34',
    }
  ],
  }
...
const toxis = {
  name: 'Toxi$',
  image: "/static/images/executors/toxi$/executor.jpeg",
  ...
  playlists: [{
    name: 'HOTSHOT',
    image: "/static/images/executors/toxi$/album1.png",
    ...
    tracks: [{
      name: 'HURTZ',
      duration: '1:44',
      url: "/static/images/executors/toxi$/tracks/HURTZ.mp3"
    },
    {
      name: "DUNKERK",
      duration: '2:16',
      url: "/static/images/executors/toxi$/tracks/DUNKERK.mp3"
    },
    {
      name: "RICKFLO",
      duration: '1:31',
      url: "/static/images/executors/toxi$/tracks/RICKFLO.mp3"
    },
    {
      name: "ГИЛИ",
      duration: '1:47',
      url: "/static/images/executors/toxi$/tracks/ГИЛИ.mp3"
    },
    {
      name: "КУПОЛ",
      duration: '1:16',
      url: "/static/images/executors/toxi$/tracks/КУПОЛ.mp3"
    },
    {
      name: "БЕСИТСЯ",
      duration: '2:26',
      url: "/static/images/executors/toxi$/tracks/БЕСИТСЯ.mp3"
    },
    {
      name: "НА ДЕНЬ",
      duration: '2:13',
      url: "/static/images/executors/toxi$/tracks/НА ДЕНЬ.mp3"
    },
    {
      name: "BB",
      duration: '3:06',
      url: "/static/images/executors/toxi$/tracks/BB.mp3"
    },
    {
      name: "ZOOTED",
      duration: '2:00',
      url: "/static/images/executors/toxi$/tracks/ZOOTED.mp3"
    },
    {
      name: "IDK",
      duration: '1:52',
      url: "/static/images/executors/toxi$/tracks/IDK.mp3"
    },
  ],
  }],
}
...
const superheaven = {
  name: 'Superheaven',
  image: "/static/images/executors/superheaven/executor.png",
  ...
  playlists: [{
    name: 'Jar',
    image: "/static/images/executors/superheaven/album1.jpeg",
    ...
    tracks: [{
      name: 'Crawl',
      duration: '2:33',
      url: "/static/images/executors/superheaven/tracks/Crawl.mp3"
    },
    {
      name: "Knew",
      url: "/static/images/executors/superheaven/tracks/Knew.mp3",
      duration: '1:18',
    },
    {
      name: "Life In A Jar",
      duration: '3:42',
      url: "/static/images/executors/superheaven/tracks/Life In A Jar.mp3"
    },
    {
      name: "No One's Deserving",
      duration: '3:03',
      url: "/static/images/executors/superheaven/tracks/No One's Deserving.mp3"
    },
    {
      name: "Sponge",
      duration: '4:23',
      url: "/static/images/executors/superheaven/tracks/Sponge.mp3"
    },
    {
      name: "Youngest Daughter",
      duration: '4:09',
      url: "/static/images/executors/superheaven/tracks/Youngest Daughter.mp3"
    },
    {
      name: "Outside Of Me",
      duration: "2:32",
      url: "/static/images/executors/superheaven/tracks/Outside Of Me.mp3"
    },
    {
      name: "Sheltered",
      duration: "2:41",
      url: "/static/images/executors/superheaven/tracks/Sheltered.mp3"
    },
    {
      name: "Last October",
      duration: "3:53",
      url: "/static/images/executors/superheaven/tracks/Last October.mp3"
    },
    {
      name: "In On It",
      duration: "3:23",
      url: "/static/images/executors/superheaven/tracks/In On It.mp3"
    },
    {
      name: "Hole In The Ground",
      duration: "4:32",
      url: "/static/images/executors/superheaven/tracks/Hole In The Ground.mp3"
    },
    {
      name: "Around The Railing",
      duration: "5:09",
      url: "/static/images/executors/superheaven/tracks/Around The Railing.mp3"
    },
  ],
  }],
}
...
const trapt = {
  name: 'Trapt',
  image: '/static/images/executors/trapt/executor.webp',
  ...
  playlists: [{
    name: 'Trapt',
    image: '/static/images/executors/trapt/album1.jpeg',
    ...
    tracks: [{
      name: 'Echo',
      duration: '4:11',
      url: '/static/images/executors/trapt/tracks/Echo.mp3'
    },
    {
      name: "Enigma",
      duration: '4:40',
      url: '/static/images/executors/trapt/tracks/Enigma.mp3'
    },
    {
      name: "Headstrong",
      duration: '4:45',
      url: '/static/images/executors/trapt/tracks/Headstrong.mp3'
    },
    {
      name: "Hollowman",
      duration: '5:03',
      url: '/static/images/executors/trapt/tracks/Hollowman.mp3'
    },
    {
      name: "Made Of Glass",
      duration: '3:29',
      url: '/static/images/executors/trapt/tracks/Glass.mp3'
    },
    {
      name: "New Beginning",
      duration: '9:12',
      url: '/static/images/executors/trapt/tracks/Beginning.mp3'
    },
    {
      name: "Still Frame",
      duration: '4:31',
      url: '/static/images/executors/trapt/tracks/Frame.mp3'
    },
    {
      name: "Stories",
      duration: '3:55',
      url: '/static/images/executors/trapt/tracks/Stories.mp3'
    },
    {
      name: "The Game",
      duration: '5:05',
      url: '/static/images/executors/trapt/tracks/The Game.mp3'
    },
    {
      name: "These Walls",
      duration: '4:05',
      url: '/static/images/executors/trapt/tracks/These Walls.mp3'
    },
    {
      name: "When All Is Said And Done",
      duration: '4:16',
      url: '/static/images/executors/trapt/tracks/When All Is Said And Done.mp3'
    },
    ],
  }],
};
...
const tyler = {
  ...
  image: '/static/images/executors/tyler/executor.jpeg',
  ...
  playlists: [{
    name: 'IGOR',
    image: '/static/images/executors/tyler/album1.jpeg',
    ...
    tracks: [{
      name: 'A BOY IS A GUN',
      duration: '3:30',
      url: '/static/images/executors/tyler/tracks/A BOY IS A GUN.mp3'
    },
    {
      name: "ARE WE STILL FRIENDS",
      duration: '4:25',
      url: '/static/images/executors/tyler/tracks/ARE WE STILL FRIENDS.mp3'
    },
    {
      name: "EARFQUAKE",
      duration: '3:10',
      url: '/static/images/executors/tyler/tracks/EARFQUAKE.mp3'
    },
    {
      name: "EXACTLY WHAT YOU RUN FROM YOU END UP CHASING",
      duration: '0:14',
      url: '/static/images/executors/tyler/tracks/EXACTLY WHAT YOU RUN FROM YOU END UP CHASING.mp3'
    },
    {
      name: "GONE, GONE THANK YOU",
      duration: '6:15',
      url: '/static/images/executors/tyler/tracks/GONE, GONE THANK YOU.mp3'
    },
    {
      name: "I DON'T LOVE YOU ANYMORE",
      duration: '2:41',
      url: "/static/images/executors/tyler/tracks/I DON'T LOVE YOU ANYMORE.mp3"
    },
    {
      name: "I THINK",
      duration: '3:32',
      url: '/static/images/executors/tyler/tracks/I THINK.mp3'
    },
    {
      name: "IGOR'S THEME",
      duration: '3:20',
      url: "/static/images/executors/tyler/tracks/IGOR'S THEME.mp3"
    },
    {
      name: "NEW MAGIC WAND",
      duration: '3:15',
      url: '/static/images/executors/tyler/tracks/NEW MAGIC WAND.mp3'
    },
    {
      name: "PUPPET",
      duration: '2:59',
      url: '/static/images/executors/tyler/tracks/PUPPET.mp3'
    },
    {
      name: "RUNNING OUT OF TIME",
      duration: '2:57',
      url: '/static/images/executors/tyler/tracks/RUNNING OUT OF TIME.mp3'
    },
    {
      name: "WHAT'S GOOD",
      duration: '3:25',
      url: "/static/images/executors/tyler/tracks/WHAT'S GOOD.mp3"
    },
    ],
  }],
};
...
const ssshhhiiittt = {
  name: 'ssshhhiiittt',
  image: '/static/images/executors/ssshhhiiittt/executor.jpg',
  ...
  playlists: [{
    name: 'Зло',
    image: '/static/images/executors/ssshhhiiittt/album1.jpg',
    ...
    tracks: [{
      name: 'Вишенка',
      duration: '4:35',
      url: '/static/images/executors/ssshhhiiittt/tracks/Вишенка.mp3'
    },
    {
      name: "Дворы",
      duration: '2:44',
      url: '/static/images/executors/ssshhhiiittt/tracks/Дворы.mp3'
    },
    {
      name: "Зверь",
      duration: '2:59',
      url: '/static/images/executors/ssshhhiiittt/tracks/Зверь.mp3'
    },
    {
      name: "Когда-нибудь",
      duration: '2:51',
      url: '/static/images/executors/ssshhhiiittt/tracks/Когда-нибудь.mp3'
    },
    {
      name: "Не скучай",
      duration: '4:13',
      url: '/static/images/executors/ssshhhiiittt/tracks/Не скучай.mp3'
    },
    {
      name: "Самый худший ученик",
      duration: '4:20',
      url: '/static/images/executors/ssshhhiiittt/tracks/Самый худший ученик.mp3'
    },
    {
      name: "Сгорел",
      duration: '2:09',
      url: '/static/images/executors/ssshhhiiittt/tracks/Сгорел.mp3'
    },
    {
      name: "Тебя нет",
      duration: '4:22',
      url: '/static/images/executors/ssshhhiiittt/tracks/Тебя нет.mp3'
    },
    ],
  }],
};
...
const saluki = {
  name: 'SALUKI',
  image: '/static/images/executors/saluki/executor.jpg',
  ...
  playlists: [{
    name: 'Огней',
    image: '/static/images/executors/saluki/album1.png',
    ...
    tracks: [{
      name: 'Огней',
      duration: '3:01',
      url: '/static/images/executors/saluki/tracks/Огней.mp3'
      },
    ],
  }],
}
...
const pepel = {
  name: 'Pepel Nahudi',
  image: '/static/images/executors/pepel/executor.jpg',
  ...
  playlists: [{
    ...
    image: '/static/images/executors/pepel/album1.jpg',
    ...
    tracks: [{
      ...
      duration: '2:13',
      url: '/static/images/executors/pepel/tracks/КТО ТЕБЕ ЭТО СКАЗАЛ.mp3'
      },
      {
        name: 'AUDIODRUG',
        duration: '1:54',
        url: '/static/images/executors/pepel/tracks/AUDIODRUG.mp3'
      },
      {
        name: "DON'T CALL ME",
        duration: '2:04',
        url: "/static/images/executors/pepel/tracks/DON'T CALL ME.mp3"
      },
      {
        name: 'ОБЪЯСНЕНИЯ',
        duration: '2:12',
        url: '/static/images/executors/pepel/tracks/ОБЪЯСНЕНИЯ.mp3'
      },
      {
        name: '#F_CKITALL',
        duration: '2:00',
        url: "/static/images/executors/pepel/tracks/#F_CKITALL.mp3"
      },
      {
        name: 'ТЫ МЕНЯ РАЗЛЮБИ',
        duration: '1:52',
        url: '/static/images/executors/pepel/tracks/ТЫ МЕНЯ РАЗЛЮБИ.mp3'
      },
    ],
  },
  {
    name: 'KINGDOM MADE',
    image: '/static/images/executors/pepel/album2.png',
    ...
    tracks: [{
      name: 'Ненадолго',
      duration: '2:28',
      url: '/static/images/executors/pepel/tracks/Ненадолго.mp3'
      },
      {
        name: 'Всё чем дорожил',
        duration: '2:13',
        url: '/static/images/executors/pepel/tracks/Всё чем дорожил.mp3'
      },
      {
        name: "Заново завоевать",
        duration: '1:52',
        url: "/static/images/executors/pepel/tracks/Заново завоевать.mp3"
      },
      {
        name: 'Дай мне',
        duration: '1:55',
        url: '/static/images/executors/pepel/tracks/Дай мне.mp3'
      },
      {
        name: 'Тунайт',
        duration: '2:40',
        url: "/static/images/executors/pepel/tracks/Тунайт.mp3"
      },
      {
        name: 'Вдохновения',
        duration: '2:22',
        url: '/static/images/executors/pepel/tracks/Вдохновения.mp3'
      },
      {
        name: "Так сложилось",
        duration: '1:48',
        url: "/static/images/executors/pepel/tracks/Так сложилось.mp3"
      },
      {
        name: 'Минерал',
        duration: '2:35',
        url: '/static/images/executors/pepel/tracks/Минерал.mp3'
      },
      {
        name: 'Звезда упала',
        duration: '2:13',
        url: "/static/images/executors/pepel/tracks/Звезда упала.mp3"
      },
      {
        name: 'Мы не видели рая Последний вдох',
        duration: '1:57',
        url: '/static/images/executors/pepel/tracks/Мы не видели рая Последний вдох.mp3'
      },
    ],
  }
  ],
...
const crystalcastles = {
  ...
  image: '/static/images/executors/crystalcastles/executor.jpg',
  ...
  playlists: [{
    name: 'Crystal Castles',
    image: '/static/images/executors/crystalcastles/album1.png',
    ...
    tracks: [
      {
        name: "Untrust Us",
        duration: "3:06",
        url: "/static/images/executors/crystalcastles/tracks/Untrust Us.mp3"
      },
      {
        name: "Alice Practice",
        duration: "2:41",
        url: "/static/images/executors/crystalcastles/tracks/Alice Practice.mp3"
      },
      {
        name: "Crimewave",
        duration: "4:18",
        url: "/static/images/executors/crystalcastles/tracks/Crimewave.mp3"
      },
      {
        name: "Magic Spells",
        duration: "6:07",
        url: "/static/images/executors/crystalcastles/tracks/Magic Spells.mp3"
      },
      {
        name: "Xxzxcuzx Me",
        duration: "1:54",
        url: "/static/images/executors/crystalcastles/tracks/Xxzxcuzx me.mp3"
      },
      {
        name: "Air War",
        duration: "4:07",
        url: "/static/images/executors/crystalcastles/tracks/Air War.mp3"
      },
      {
        name: "Courtship Dating",
        duration: "3:32",
        url: "/static/images/executors/crystalcastles/tracks/Courtship Dating.mp3"
      },
      {
        name: "Good Time",
        duration: "2:59",
        url: "/static/images/executors/crystalcastles/tracks/Good Time.mp3"
      },
      {
        name: "1991",
        duration: "1:53",
        url: "/static/images/executors/crystalcastles/tracks/1991.mp3"
      },
      {
        name: "Vanished",
        duration: "4:02",
        url: "/static/images/executors/crystalcastles/tracks/Vanished.mp3"
      },
      {
        name: "Knights",
        duration: "3:00",
        url: "/static/images/executors/crystalcastles/tracks/Knights.mp3"
      },
      {
        name: "Love and Caring",
        duration: "2:19",
        url: "/static/images/executors/crystalcastles/tracks/Love And Caring.mp3"
      },
      {
        name: "Through the Hosiery",
        duration: "3:06",
        url: "/static/images/executors/crystalcastles/tracks/Through The Hosiery.mp3"
      },
      {
        name: "Reckless",
        duration: "3:28",
        url: "/static/images/executors/crystalcastles/tracks/Reckless.mp3"
      },
      {
        name: "Black Panther",
        duration: "2:57",
        url: "/static/images/executors/crystalcastles/tracks/Black Panther.mp3"
      },
      {
        name: "Tell Me What to Swallow",
        duration: "2:14",
        url: "/static/images/executors/crystalcastles/tracks/Tell Me What To Swallow.mp3"
      }      
    ],
  },
  {
    name: 'Alice Practice',
    image: '/static/images/executors/crystalcastles/album2.jpg',
...
const articlesServer = [
  {
    ...
    image: "/static/images/blog/article1/first.jpg",
    image_2: "/static/images/blog/article1/second.jpeg",
  ...
  },
  {
    ...
    image: '/static/images/blog/article2/first.jpg',
    image_2: "/static/images/blog/article2/second.jpeg",
    subtitle: "Vladislav Dmitrievich Kozikhov, known by his stage name Dzhizus, is a Russian musician, singer, and songwriter. Born on October 9, 1994, he is recognized for his unique blend of hip-hop, electronic, and rock music. His emotionally charged lyrics often explore themes of love, loss, self-discovery, and social issues. Dzhizus gained popularity in the late 2010s and continues to be an influential figure in contemporary music."
  },
  {
    ...
    image: '/static/images/blog/article3/first.png',
    image_2: "/static/images/blog/article3/second.jpeg",
  ...
  },
  {
    ...
    image: '/static/images/blog/article4/first.jpeg',
    image_2: "/static/images/blog/article4/second.png",
  ...
  },
  {
    ...
    image: '/static/images/blog/article5/first.jpeg',
    image_2: "/static/images/blog/article5/second.jpeg",
  ...
  },
  {
    ...
    image: '/static/images/blog/article6/first.jpg',
    image_2: "/static/images/blog/article6/second.webp",
    subtitle: "Andrey Smelyanskiy, known as Toxi$, is a rising Russian musician blending hip-hop, trap, and electronic music. Starting his career in the early 2020s, he quickly gained recognition with his emotionally rich tracks that explore personal and social themes. Collaborating with various artists, Toxi$ experiments with new sounds and styles. His energetic performances and charismatic stage presence make his concerts unforgettable. As he continues to release new music, Toxi$ is steadily climbing the ranks of the music industry."
  },
  {
    name: 'Favorite monkeys',
    title: 'Feel like a beautiful monkey, free to sleep all your life.',
    image: '/static/images/blog/article7/first.jpg',
    image_2: '/static/images/blog/article7/second.jpg',
  ...
  },
  {
    ...
    image: '/static/images/blog/article8/first.jpg',
    image_2: '/static/images/blog/article8/second.jpg',
    subtitle: '', 
  },
  {
    name: 'Skate music',
    ...
    image: '/static/images/blog/article9/first.avif',
    image_2: '/static/images/blog/article9/second.avif',
  ...
  },
  {
    ...
    image: '/static/images/blog/article10/first.jpg',
    image_2: '/static/images/blog/article10/second.jpg',
