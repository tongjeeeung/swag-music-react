...
const jesus = {
  ...
  playlists: [
    ...
    {
      name: "ПСИХО-НЕВРОЛОГИЧЕСКИЕ ЗАБОЛЕВАНИЯ С ВИДИМОСТЬЮ НЕВИДИМЫХ СУЩЕСТВ",
      image: "/swag-music-react/static/images/executors/jezus/album3.jpg",
      information:
        'The album "Psycho-Neurological Disorders with the Visibility of Invisible Beings" by the band Djizus is a unique musical work that blends alternative rock and experimental music. It explores themes of mental health, inner struggle, and perception of reality. The music features a rich soundscape, combining live instruments with electronic elements. The lyrics address complex and often dark aspects of the human experience, including fear, loneliness, and the battle with inner demons. Overall, the album attempts to convey emotional states and experiences related to psycho-neurological disorders, creating an atmosphere that immerses the listener in a world where invisible beings symbolize internal conflicts and fears. It is a deep and layered work that evokes a wide range of emotions and reflections on the nature of human consciousness.',
      tracks: [
        {
          name: "4 (Интро)",
          duration: "1:12",
          url: "/swag-music-react/static/images/executors/jezus/tracks/4 (Интро).mp3",
        },
        {
          name: "Автотюновая поп-песня",
          duration: "2:16",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Автотюновая поп песня.mp3",
        },
        {
          name: "Город «Изумруд»",
          duration: "3:24",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Город Изумруд.mp3",
        },
        {
          name: "Автотюновая рок-песня",
          duration: "2:14",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Автотюновая рок песня.mp3",
        },
        {
          name: "Moon Man",
          duration: "1:18",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Moon Man.mp3",
        },
        {
          name: "Подсознание мёртвого музыканта",
          duration: "2:40",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Подсознание мёртвого музыканта.mp3",
        },
        {
          name: "Разговоры с Богом",
          duration: "2:22",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Разговоры с Богом.mp3",
        },
        {
          name: "На моих ладонях",
          duration: "2:52",
          url: "/swag-music-react/static/images/executors/jezus/tracks/На моих ладонях.mp3",
        },
        {
          name: "7 Аутро",
          duration: "1:36",
          url: "/swag-music-react/static/images/executors/jezus/tracks/7 Аутро.mp3",
        },
        {
          name: "Божественная комедия",
          duration: "2:39",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Божественная комедия.mp3",
        },
        {
          name: "Ван гог",
          duration: "1:36",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Ван гог.mp3",
        },
        {
          name: "Голос МОНСТРА",
          duration: "2:13",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Голос МОНСТРА.mp3",
        },
        {
          name: "Группа крови",
          duration: "2:40",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Группа крови.mp3",
        },
        {
          name: "Меня заебал рэп",
          duration: "2:28",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Меня заебал рэп.mp3",
        },
        {
          name: "Первый среди последних",
          duration: "1:24",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Первый среди последних.mp3",
        },
        {
          name: "Почему горят небеса",
          duration: "2:41",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Почему горят небеса.mp3",
        },
        {
          name: "Силуэты демонов прохожих",
          duration: "2:12",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Силуэты демонов прохожих.mp3",
        },
      ],
    },
    {
      name: "НОГА В НОГУ С ЭТОЙ СТРАНОЙ",
      image: "/swag-music-react/static/images/executors/jezus/album4.jpg",
      information:
        'The album "Keeping up with this Country" by the band Jesus is a piece of music that combines elements of alternative rock and post-punk. It explores the themes of social justice, identity, and cultural conflict. The music is characterized by energetic rhythms and expressive melodies, and the lyrics touch on current issues and experiences faced by society. The album creates an atmosphere that encourages the listener to reflect on their place in the world and how personal and collective stories intertwine.',
      tracks: [
        {
          name: "12 июня 1997",
          duration: "2:53",
          url: "/swag-music-react/static/images/executors/jezus/tracks/12 июня 1997.mp3",
        },
        {
          name: "Любимая песня на альбоме",
          duration: "2:12",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Любимая песня на альбоме.mp3",
        },
        {
          name: "Дефибриллятор мозга",
          duration: "2:04",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Дефибриллятор мозга.mp3",
        },
        {
          name: "ДЖИЗУС, ТЫ ЮВЕЛИР!",
          duration: "1:53",
          url: "/swag-music-react/static/images/executors/jezus/tracks/ДЖИЗУС, ТЫ ЮВЕЛИР!.mp3",
        },
        {
          name: "ДОЛБОЁБАМ - НЕТ!",
          duration: "1:39",
          url: "/swag-music-react/static/images/executors/jezus/tracks/ДОЛБОЁБАМ - НЕТ!.mp3",
        },
        {
          name: "Дубль 59 (Скит)",
          duration: "1:56",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Дубль 59 (Скит).mp3",
        },
        {
          name: "ЗАШИТЫЙ РОТ",
          duration: "1:29",
          url: "/swag-music-react/static/images/executors/jezus/tracks/ЗАШИТЫЙ РОТ.mp3",
        },
        {
          name: "Золото",
          duration: "2:20",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Золото.mp3",
        },
        {
          name: "Кожихов Владислав Дмитриевич",
          duration: "2:31",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Кожихов Владислав Дмитриевич.mp3",
        },
        {
          name: "НАХУЙ СТИЛЬ!",
          duration: "2:16",
          url: "/swag-music-react/static/images/executors/jezus/tracks/НАХУЙ СТИЛЬ!.mp3",
        },
        {
          name: "Песня пьяного одиночества",
          duration: "2:31",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Песня пьяного одиночества.mp3",
        },
      ],
    },
    {
      name: "НАЧАЛО НОВОЙ ЭРЫ",
      image: "/swag-music-react/static/images/executors/jezus/album5.jpg",
      information:
        'The album "The Beginning of a New Era" by the band Jesus is a piece of music that combines elements of alternative rock and indie. This album explores themes of change, hope, and striving for a better future. The music is characterized by melodiousness and atmospheric sounds, and the lyrics touch on personal and social experiences, reflecting the spirit of the times. The album creates a sense of optimism and inspiration, encouraging the listener to believe in the possibility of change and a new beginning.',
      tracks: [
        {
          name: "Я не хочу стать твоим кумиром",
          duration: "0:53",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Я не хочу стать твоим кумиром.mp3",
        },
        {
          name: "РАССВЕТ",
          duration: "3:52",
          url: "/swag-music-react/static/images/executors/jezus/tracks/РАССВЕТ.mp3",
        },
        {
          name: "Сияние неба не видно глазами",
          duration: "2:59",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Сияние неба не видно глазами.mp3",
        },
        {
          name: "Я познал себя",
          duration: "3:19",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Я познал себя.mp3",
        },
        {
          name: "ТЫ НИЧЕГО НЕ ПОНЯЛА",
          duration: "2:54",
          url: "/swag-music-react/static/images/executors/jezus/tracks/ТЫ НИЧЕГО НЕ ПОНЯЛА.mp3",
        },
        {
          name: "ТЫ СТАЛА ПРОСТО СУПЕР",
          duration: "2:54",
          url: "/swag-music-react/static/images/executors/jezus/tracks/ТЫ СТАЛА ПРОСТО СУПЕР.mp3",
        },
        {
          name: "Боль",
          duration: "2:36",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Боль.mp3",
        },
        {
          name: "ДЛЯ ТЕХ КТО ЕЩЁ ЖИВ",
          duration: "2:46",
          url: "/swag-music-react/static/images/executors/jezus/tracks/ДЛЯ ТЕХ КТО ЕЩЁ ЖИВ.mp3",
        },
        {
          name: "ДЛЯ ТЕХ КТО УЖЕ МЁРТВ",
          duration: "3:14",
          url: "/swag-music-react/static/images/executors/jezus/tracks/ДЛЯ ТЕХ КТО УЖЕ МЁРТВ.mp3",
        },
        {
          name: "Ограбленный магазин",
          duration: "4:59",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Ограбленный магазин.mp3",
        },
        {
          name: "Моя подруга",
          duration: "3:59",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Моя подруга.mp3",
        },
        {
          name: "ТЫ В ПРОШЛОМ!",
          duration: "3:14",
          url: "/swag-music-react/static/images/executors/jezus/tracks/ТЫ В ПРОШЛОМ!.mp3",
        },
        {
          name: "Забывай меня",
          duration: "4:39",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Забывай меня.mp3",
        },
        {
          name: "Догорай",
          duration: "2:20",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Догорай.mp3",
        },
        {
          name: "Ангел",
          duration: "2:51",
          url: "/swag-music-react/static/images/executors/jezus/tracks/Ангел.mp3",
        },
      ],
    },
  ],
  ...
  playlists: [
    {
      ...
      information:
        "'HOTSHOT' is the latest album by Russian hip-hop artist Toxi$, released in 2023. Known for his distinctive blend of trap, hip-hop, and electronic music, Toxi$ delivers an album that is both innovative and deeply personal.",
      tracks: [
        {
          name: "HURTZ",
          duration: "1:44",
...
const superheaven = {
  ...
  about:
    "Superheaven is an American rock band known for their grunge-influenced sound and emotionally charged lyrics. Formed in 2008 in Doylestown, Pennsylvania, the band originally went by the name Daylight before rebranding to Superheaven in 2014. Their music blends elements of alternative rock, grunge, and punk, creating a nostalgic yet fresh sound that resonates with fans of 90s rock.",
  playlists: [
    {
      name: "Jar",
      image:
        "/swag-music-react/static/images/executors/superheaven/album1.jpeg",
      information:
        "The album 'Jar' explores themes of personal experiences, struggles with inner demons, and the search for meaning in life. Superheaven's music is characterized by powerful guitar riffs, emotional vocal performances, and atmospheric sound, which makes them unique in their genre.",
      tracks: [
        {
          name: "Crawl",
          duration: "2:33",
...
const trapt = {
  ...
  about:
    "Trapt is an American rock band formed in Los Gatos, California, in 1995. The band is known for its post-grunge and alternative metal sound. The original lineup consisted of Chris Taylor Brown (vocals), Simon Ormandy (guitar), Peter Charell (bass), and David Stege (drums).",
  playlists: [
    {
      name: "Trapt",
      image: "/swag-music-react/static/images/executors/trapt/album1.jpeg",
      information:
        'The album "Trapt" was well-received and helped establish the band in the rock music scene. It remains a significant part of their discography. If you have any more questions or need further details, feel free to ask!',
      tracks: [
        {
          name: "Echo",
          duration: "4:11",
...
const crystalcastles = {
  ...
  playlists: [
    ...
    },
    {
      name: "Alice Practice",
      image:
        "/swag-music-react/static/images/executors/crystalcastles/album2.jpg",
      information:
        "'Alice Practice' is a song by the Canadian electronic band Crystal Castles. It was released as the band's debut single in 2006 and later included in their self-titled debut album, 'Crystal Castles', which was released in 2008.",
      tracks: [
        {
          name: "Alice Practice",
          duration: "2:43",
...
const articlesServer = [
  ...
  },
  {
    ...
    title:
      "Dzhizus' album 'Не Пара' is a captivating exploration of deep emotions and innovative soundscapes. This article delves into the heart of 'Не Пара,' analyzing its poignant lyrics, diverse musical influences, and the artistic vision that defines Dzhizus' work. Discover how Dzhizus crafts a narrative of love, loss, and self-reflection, creating a powerful and resonant experience for listeners. Join us as we unpack the themes, production techniques, and creative inspiration behind 'Не Пара,' highlighting its significance in the contemporary music scene.",
  ...
  },
  {
    ...
    title:
      "Toxi$'s latest album 'Hotshot' bursts onto the scene with high energy, captivating beats, and sharp lyricism. This article takes an in-depth look at 'Hotshot,' exploring its standout tracks, innovative production, and the themes permeating Toxi$'s fiery delivery. Dive into the creative process behind the album and understand how Toxi$ continues to push the boundaries of the contemporary music landscape. With its dynamic sound and bold personality, 'Hotshot' is set to solidify Toxi$'s place as a force to be reckoned with in the industry.",
  ...
  },
  {
    ...
    subtitle:
      "Monkeys captivate many with their intelligence and playfulness. Here are a few favorites: 1. Chimpanzees: Intelligent primates that use tools and communicate with gestures. They live in complex social groups.<br>2. Orangutans: Wise and calm, these primates from Borneo and Sumatra spend much time in trees, eating fruit. 3. Gorillas: The largest primates, living in family groups. They symbolize strength and tranquility. 4. Capuchins: Small but smart monkeys known for their curiosity and learning ability. 5. Macaques: Common in Asia, these monkeys have complex social hierarchies and adapt well to living near humans.",
  },
  {
  ...
  },
  {
    ...
    subtitle:
      "Some of them have already released debut albums that have received positive reviews from critics and listeners. Their music often reflects contemporary trends and issues, making it particularly relevant for the younger generation. In 2024, we can expect many interesting releases and concerts from these new talents, who will undoubtedly shape the musical landscape of the coming years.",
  },
];
...
const initializeDatabase = async () => {
  try {
    ...
    for (const artistData of artists) {
      ...
      let totalAuditions = 0; // Переменная для подсчета всех прослушиваний

      const playlists = artistData.playlists.map((playlist) => {
        let playlistId = playlist._id;

        if (existingArtist) {
          const existingPlaylist = existingArtist.playlists.find(
        ...
        const tracks = playlist.tracks.map((track) => {
          ...
          totalAuditions += auditions; // Увеличиваем общий счетчик прослушиваний
          ...
          return {
            ...
            albumName: playlist.name, // Добавляем название альбома
      ...
      const artist = await Artist.findOneAndUpdate(
        { name: artistData.name },
        {
          ...
          playlists,
          allAuditions: totalAuditions, // Добавляем общее количество прослушиваний
        },
        { upsert: true, new: true, setDefaultsOnInsert: true },
      );

      console.log(
        `Артист ${artistData.name} успешно добавлен или обновлен в базе данных`,
      );
    }
    ...
    for (const blogData of blogs) {
      ...
      console.log(
        `Блог ${blogData.name} успешно добавлен или обновлен в базе данных`,
      );
    }
  } catch (error) {
